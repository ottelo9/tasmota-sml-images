...
// ESP32-P4 has no radio of its own; BLE runs via the on-board ESP32-C6 controller over ESP-Hosted (HCI tunneled on the SDIO link). NimBLE host stack is the same.
#ifdef USE_BLE_ESP32
