...
// Fork-owned: the whole TinyC<->LVGL glue (handle table + every tc_lv_* backend)
// lives in its own include so this upstream file stays minimal. Put NEW TinyC/LVGL
// bindings in the .inc, not here.  (FORK HYGIENE)
#include "tasmota_xdrv_driver/xdrv_54_lvgl_tinyc.inc"
